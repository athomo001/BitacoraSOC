...
router.post('/forgot-password',
  ...
  async (req, res) => {
    try {
      ...
      // Importación local y generación del contenido usando la plantilla centralizada
      const { buildPasswordRecoveryEmail } = require('../templates/email');
      const { html, text } = buildPasswordRecoveryEmail({ resetUrl, systemName, teamName });
