...
router.put('/',
  ...
  [
    ...
    // Validación actualizada para incluir el nuevo tema de login split-screen independiente
    body('loginTheme').optional().isIn(['crt', 'infoflow', 'modern']).withMessage('Tema inválido'),
