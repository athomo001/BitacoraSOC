...
router.put('/',
  ...
  [
    ...
    // Validación actualizada para incluir los temas de login alternativos
    body('loginTheme').optional().isIn(['crt', 'infoflow', 'modern', 'surrealism']).withMessage('Tema inválido'),
    ...
    body('birthdayEmailsCcAddress').optional({ checkFalsy: true }).trim().isEmail().withMessage('Correo de área inválido'),
