...
## [Rewrite] Fase 8 — Turnos, Rotación y Dotación — implementada, verificación real pendiente - 2026-09-23
...
- **Verificado**: la lógica (Go y Angular) tiene pruebas automáticas y pasan todas, y ambos proyectos compilan limpios. **No se pudo levantar el stack completo (Postgres/correo de prueba) en este entorno de trabajo**, así que falta la ronda de verificación contra el sistema real de punta a punta que sí se hizo en las fases anteriores (probar los endpoints contra una base de datos real, abrir la pantalla en un navegador) — queda pendiente antes de dar la fase por cerrada del todo.
